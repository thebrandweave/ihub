...
<aside class="w-64 flex-shrink-0" aria-label="Sidebar">
    <div class="flex flex-col h-full bg-gray-800 text-white">
        ...
        <div class="h-20 flex items-center justify-center bg-gray-900">
            <a href="/ihub/admin/index.php" class="text-2xl font-bold">iHub Admin</a>
        </div>

        <!-- Sidebar Links -->
        <nav class="flex-1 px-4 py-4 space-y-2">
            <p class="px-4 py-2 text-xs text-gray-400 uppercase">Menu</p>
            <a href="/ihub/admin/index.php" class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md <?= ($current_page == 'index.php') ? 'bg-gray-700' : '' ?>">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                <span class="font-medium">Dashboard</span>
            </a>
            <a href="/ihub/admin/admin/index.php" class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md <?= ($current_page == 'index.php' && strpos($_SERVER['REQUEST_URI'], '/admin/admin') !== false) ? 'bg-gray-700' : '' ?>">
        ...
        <div class="px-4 py-4 border-t border-gray-700">
             <a href="/ihub/admin/auth/logout.php" class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
